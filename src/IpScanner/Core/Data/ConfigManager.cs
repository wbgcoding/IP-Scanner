...
public static class ConfigManager
{
    ...
    public static void Save(string path, ScanConfig c)
    {
        ...
        sb.AppendLine("# startup_ping_count  Pings je Geraet beim Auto-Scan nach dem Start (0-10000). Standard 10.");
        sb.AppendLine($"startup_ping_count = {c.StartupPingCount}");
        sb.AppendLine("# offline_recheck_seconds  Offline-IPs alle N Sekunden erneut pruefen (0 = aus). Standard 5.");
